...
export default function DivisionModuleAssignmentsSection({
  ...
  return (
    <div className="grid gap-6">
      <div className="shrink-0 rounded-3xl border border-white/10 bg-[#141414] p-5 shadow-[0_12px_40px_rgba(0,0,0,0.25)]">
      ...
      <div className="shrink-0 grid gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-white/10 bg-[#1a1a1a] px-4 py-4 shadow-[0_12px_40px_rgba(0,0,0,0.25)]">
